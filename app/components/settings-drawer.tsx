                ...
                <div className="space-y-6">
                  {isMetaMaskConnected ? (
                    <div className="space-y-4">
                      ...
                      <Button className="w-full text-white hover:text-[#31C4B9]" onClick={disconnectMetaMask}>
                        Disconnect MetaMask
                      </Button>
                    </div>
                  ) : (
                    <Button className="w-full text-white hover:text-[#31C4B9]" onClick={connectMetaMask}>
                      Connect MetaMask
                    </Button>
                  )}
                  <Button className="w-full text-white hover:text-[#31C4B9]" onClick={addNetworkToMetaMask}>
