      ...
      <div className="md:w-1/2 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-400 text-lg">
            Our MEV-protected RPC infrastructure ensures your transactions are shielded from
            front-running and other malicious activities. Experience faster, more secure Ethereum
            interactions.
          </p>
        </div>
      </div>
