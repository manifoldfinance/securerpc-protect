	...
	return (
		<div className="space-y-8">
				...
				<table className="w-full">
					<thead>
						<tr className="border-b border-white/10">
							...
							<th className="text-left py-4 px-4 font-medium text-gray-400">
								Connected to user addresses?
							</th>
							<th className="text-left py-4 px-4 font-medium text-gray-400">
								Who collects
							</th>
							<th className="text-left py-4 px-4 font-medium text-gray-400">
								Why is it collected and how it is used
							</th>
							<th className="text-left py-4 px-4 font-medium text-gray-400">
								Retention by SecureRPC
							</th>
						</tr>
					</thead>
					<tbody>
			...
			<p className="text-gray-400">
				SecureRPC is committed to protecting user privacy and preventing
				censorship. The above table illustrates our data collection and
				retention policies.
			</p>

			<Link
				href="/about"
				className="inline-flex items-center text-[#31C4B9] hover:underline"
			>
