				...
				<div className="relative border border-[var(--slate-3)]">
					<div className="grid lg:grid-cols-[1fr,auto]">
						...
						<div className="p-8 relative">
							<span className="absolute top-4 right-4 text-[var(--slate-7)] text-sm">
								01
							</span>
						...
						<div className="relative p-8 border-l border-[var(--slate-3)] lg:w-[400px]">
							...
							<div className="space-y-6 text-[var(--slate-11)]">
								<p>
									MEV strategies (α, β, γ, δ, ε) each for different market
							...
							<div className="relative mt-8 border border-[var(--slate-3)] p-8">
								...
								<div className="space-y-6 text-[var(--slate-11)]">
									<p>
										Our MEV extraction strategies are designed to maximize value
										while maintaining market integrity. They adapt to changing
										market conditions and regulatory requirements, ensuring
										sustainable and ethical value extraction.
									</p>
								</div>
							</div>
						</div>
