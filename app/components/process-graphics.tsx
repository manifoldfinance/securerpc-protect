	...
	return (
		<div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center justify-items-center">
			...
			<div className="relative w-32 h-32">
				...
				<svg ref={gridRef} viewBox="0 0 100 100" className="w-full h-full transition-all duration-500">
					<g stroke="currentColor" className="text-[#31C4B9]/40" strokeWidth="2" fill="none">
			...
			<div className="relative w-32 h-32">
				{/* biome-ignore lint/a11y/noSvgWithoutTitle: Process Call to Action */}
				<svg ref={curveRef} viewBox="0 0 100 100" className="w-full h-full transition-all duration-500">
					<path
			...
			<div className="relative w-32 h-32">
				{/* biome-ignore lint/a11y/noSvgWithoutTitle: Process Call to Action */}
				<svg ref={circleRef} viewBox="0 0 100 100" className="w-full h-full transition-all duration-500">
					<circle
						cx="50"
						cy="50"
						r="40"
						...
						fill="none"
					/>
					<path d="M 50 50 m -40 0 a 40 40 0 0 1 80 0" stroke="#31C4B9" strokeWidth="2" fill="none" />
