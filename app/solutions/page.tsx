					...
					<div className="grid md:grid-cols-3 gap-8 text-center">
						<div className="space-y-4">
							...
							<p className="text-gray-400">
								Strategic transaction placement ensures optimal execution within the block
							</p>
						</div>
						<div className="space-y-4">
							<h3 className="text-xl font-semibold">Path Optimization</h3>
							<p className="text-gray-400">Advanced routing algorithms find the most efficient transaction paths</p>
						</div>
						<div className="space-y-4">
							<h3 className="text-xl font-semibold">Timing Control</h3>
							<p className="text-gray-400">Precise execution timing maximizes transaction success rates</p>
						</div>
					</div>
				</div>
			</section>
				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					<div className="space-y-6">
						<p className="text-lg text-gray-400">
							SecureRPC uses advanced transaction ordering and protection mechanisms to ensure your transactions are
							processed securely and efficiently.
						</p>
						<div className="space-y-4">
							<div className="space-y-2">
								<h3 className="text-xl font-semibold">α - Standard Transaction Flow</h3>
								<p className="text-gray-400">
									Shows the baseline transaction ordering where transactions are processed sequentially without
									protection.
								</p>
							</div>
							<div className="space-y-2">
								<h3 className="text-xl font-semibold">β - Pre-validation Protection</h3>
								<p className="text-gray-400">
									Introduces protected transaction slots (Ta) with validation checks before processing.
								</p>
							</div>
							<div className="space-y-2">
								<h3 className="text-xl font-semibold">γ - Optimized Batch Processing</h3>
								<p className="text-gray-400">
									Implements batched transaction processing with protected slots for better efficiency.
								</p>
							</div>
							<div className="space-y-2">
								<h3 className="text-xl font-semibold">δ - Enhanced Protection Layer</h3>
								<p className="text-gray-400">
									Adds an additional layer of protection while maintaining efficient processing order.
								</p>
							</div>
							<div className="space-y-2">
								<h3 className="text-xl font-semibold">ε - Advanced MEV Protection</h3>
								<p className="text-gray-400">
									Implements our full MEV protection suite with multiple secure transaction slots.
								</p>
							</div>
						</div>
					</div>
					<div className="relative">
						<div className="bg-black/40 rounded-lg p-8 border border-white/10">
							<img src="/tx_ordering_diagram.png" alt="Transaction Ordering Diagram" className="w-full h-auto" />
						</div>
