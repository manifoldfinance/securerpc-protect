        ...
        <div className="space-y-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400">
                Advanced routing algorithms find the most efficient transaction paths
              </p>
            </div>
            <div className="space-y-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <p className="text-lg text-gray-400">
              SecureRPC uses advanced transaction ordering and protection mechanisms to ensure your
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-gray-400">
                  Shows the baseline transaction ordering where transactions are processed
                  sequentially without protection.
                </p>
              </div>
              <div className="space-y-2">
                <h3 className="text-xl font-semibold">β - Pre-validation Protection</h3>
                <p className="text-gray-400">
                  Introduces protected transaction slots (Ta) with validation checks before
                  processing.
                </p>
              </div>
              <div className="space-y-2">
                ...
                <p className="text-gray-400">
                  Implements batched transaction processing with protected slots for better
                  efficiency.
                </p>
              </div>
              <div className="space-y-2">
                ...
                <p className="text-gray-400">
                  Adds an additional layer of protection while maintaining efficient processing
                  order.
                </p>
              </div>
              <div className="space-y-2">
