  ...
  return (
    <div className="max-w-3xl">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Using <code className="bg-gray-800 px-2 py-1 rounded text-sm">Wagmi</code>, you can just
          set your RPC URL to: `https://api.securerpc.com/v1`
        </p>
      </section>
    ...
    MyContract: {
      ...
      <section>
        ...
        <p className="mb-4">
          ...
          <code className="bg-gray-800 px-2 py-1 rounded text-sm">.env</code> file in your project
          root and add your variables there.
        </p>
        <pre className="bg-gray-800 p-4 rounded-md overflow-x-auto">
          <code className="text-sm text-white">
