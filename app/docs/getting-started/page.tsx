  ...
  return (
    <div className="max-w-3xl">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          SecureRPC is an open-source backend framework for building robust, performant, and
          maintainable crypto apps. It allows you to rapidly build an API for any EVM smart
          contract.
        </p>
      </section>
