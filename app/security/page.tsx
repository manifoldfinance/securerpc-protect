		...
		<>
			<main className="flex-grow container mx-auto px-6 py-12">
				...
				<section className="mb-8">
					...
					<p className="mb-4">
						At SecureRPC, we prioritize the security and integrity of our
						infrastructure and your data. Our team of security experts
						continuously monitors and improves our systems to ensure the highest
						level of protection.
					</p>
				</section>
				<section className="mb-8">
					...
					<p className="mb-4">
						For secure communication, you can use our PGP public key:
					</p>
					<pre className="bg-gray-800 p-4 rounded-md overflow-x-auto mb-4">
						<code className="text-sm text-white">
							...
							jbeIFPGcvNUG6xIPj/sdqLp2Fym35Q28jD2ZAw== =IfjR -----END PGP PUBLIC
							KEY BLOCK-----
						</code>
					</pre>
				</section>
				<section className="mb-8">
					...
					<p className="mb-4">
						If you believe you've found a security vulnerability in our systems,
						please responsibly disclose it to us by emailing sam -at-
						manifoldfinance.com
					</p>
				</section>
				<section>
					...
					<p className="mb-4">
						We regularly conduct third-party security audits of our
						infrastructure and smart contracts. You can find our latest audit
						reports here:
					</p>
